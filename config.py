...
class Config():
    ...
    def parse(self):
        ...
        ###parsing
        parser.add_argument('--input_nc_G_parsing', type=int, default=45, help='# of input image channels: 3 for RGB and 1 for grayscale')  # [3,3,20]  36 / 23 / 26 parsing/gen/MPV gen/
        parser.add_argument('--input_nc_D_parsing', type=int, default=65, help='# of input image channels: 3 for RGB and 1 for grayscale')  # 40 / 6  / 6
        ...
        parser.add_argument('--batch_size_t', type=int, default=1)
        parser.add_argument('--batch_size_v', type=int, default=1)
        ...
        ### resume dir
        parser.add_argument('--resume_gmm', default='', type=str)
        parser.add_argument('--resume_G_parse', default='', type=str)
        parser.add_argument('--resume_G_app', default='', type=str)
        parser.add_argument('--resume_G_face', default='', type=str)
