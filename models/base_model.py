...
class BaseModel(ABC):
    ...
    def __init__(self, opt):
        ...
        # log dir
        if opt.joint_all:
            self.save_dir = os.path.join('net_model_densepose', 'joint_checkpoint', opt.suffix)
        else:   
            self.save_dir = os.path.join('net_model_densepose', opt.train_mode + '_checkpoint', opt.suffix)
