...
def forward(opt, paths, gpu_ids, refine_path):
    ...
    with torch.no_grad():
        for i, result in enumerate(val_dataloader):
            ...
            refine_img_fake_face = generate_img_without_face + fake_face
            refine_img_real_face =  generate_img_without_face + source_face
            ...
            "save results"
            images = [source_image, cloth_image, target_pose_img, warped_cloth, source_parse_vis, generate_parse_vis, refine_img]
